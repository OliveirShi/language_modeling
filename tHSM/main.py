...
def train(lr):
    ...
    train_data=TextIterator(train_datafile,freqs_file,n_words_source=n_words_source,n_batch=n_batch)
    valid_data=TextIterator(valid_datafile,freqs_file,n_words_source=n_words_source,n_batch=n_batch)
    test_data=TextIterator(test_datafile,freqs_file,n_words_source=n_words_source,n_batch=n_batch)
